...
<%@ page import="org.jfree.chart.ChartFactory,org.jfree.chart.JFreeChart,
 ...
 org.jfree.ui.RectangleInsets,
  org.jfree.chart.labels.*,org.jfree.ui.*,org.jfree.chart.axis.*,java.util.*"%>
<%
//访问量统计时间线
TimeSeries timeSeries = new TimeSeries("某网站访问量统计", Month.class);
//时间曲线数据集合 
TimeSeriesCollection lineDataset = new TimeSeriesCollection();
//构造数据集合 timeSeries.add(new Month(1, 2010), 1100);
...
String filename = ServletUtilities.saveChartAsPNG(chart, 500, 360, null, session);
